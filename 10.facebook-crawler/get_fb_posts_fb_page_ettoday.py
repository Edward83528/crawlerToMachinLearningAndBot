...
access_token = app_id + "|" + app_secret # 已失效

access_token = "放入你的Access Token"

# input date formatted as YYYY-MM-DD
since_date = "2019-03-20"
until_date = "2019-03-25"
...
def processFacebookPageFeedStatus(status):
    ...
    status_published = status_published + \
        datetime.timedelta(hours=+8)  # EST
...
def scrapeFacebookPageFeedStatus(page_id, access_token, since_date, until_date):
    with open('{}_facebook_statuses.csv'.format(page_id), 'w', encoding='utf-8') as file:
        ...
        after = ''
        base = "https://graph.facebook.com/v3.3"
